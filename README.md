...
## Evaluation
The pretrained models further were evaluated based on the rotational velocity profiles derive from the idealized impact dataset (N=1521): https://link.springer.com/article/10.1007%2Fs10439-017-1888-3. The example testing results in terms of coefficient of determination (R^2) and root mean squared error (RMSE) are shown below:

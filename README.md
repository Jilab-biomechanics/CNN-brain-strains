...
When instead training the CNN using the idealized impacts (N=1521) with the corresponding pretrained CNN models for fine-tuning, the resulting 10-fold cross-validation accuracy is shown below (virtually perfect performance).

...
## Evaluation
The pretrained models further were evaluated based on the rotational velocity profiles derive from the idealized impact dataset (N=1521):https://www.ncbi.nlm.nih.gov/pubmed/28710533. The example testing results in terms of coefficient of determination (R^2) and root mean squared error (RMSE) are shown below:
